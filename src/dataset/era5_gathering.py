...
for date in dates:
    ...
    print(f'Downloading ERA5 variable maps for iso time {year}-{month:02d}-{day:02d} {hour:02d}:00')
    ...
    for i in range(6):
        ...
        tc.era5.retrieve_era5_single_levels(client=client, out_dir=dataset_tmp_wind_gust_dir, variables=wind_post_processing, south=south, north=north, west=west, east=east, year=year, month=month, day=day, hour=hour)
