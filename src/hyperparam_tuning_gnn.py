...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    ...
    # load dataloader
    train_loader = DataLoader(train_dataset, batch_size=params['batch_size'], shuffle=True, drop_last=drop_remainder)
    valid_loader = DataLoader(valid_dataset, batch_size=512, shuffle=False, drop_last=drop_remainder) # fixed batch size to keep the testing even
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    ...
    tester = GraphTester(device=device, loader=valid_loader, model=model, n_cyclones=valid_dataset.n_cy, nodes_per_graph=model_args['nodes_per_graph'])
